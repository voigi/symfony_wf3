 ...
 */
final class Version20210212092214 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD auteur_id INT NOT NULL, CHANGE publi publie TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP auteur_id, CHANGE publie publi TINYINT(1) NOT NULL');
    }
}
